...
import imgabout from "./../../public/images/How road freight transport can help achieve climate goals.jpg";
import { useTranslation } from "react-i18next";
import { capitalizeEachWord } from "../utility";
import Nav from "../components/Nav";
function CustomsBusiness() {
        ...
        >
          ...
          <Box mx={4}>
            <Text
              ...
              width={"100%"}
            >
              {capitalizeEachWord(t("Customs-Business-info"))}
            </Text>
          </Box>
        </Grid>
      </Container>
...
export default CustomsBusiness;
